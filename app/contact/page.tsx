...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    formData.append("access_key", "629edf10-e2a1-4f25-987c-2f6cad013911");

    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        method: "POST",
        body: formData, // Web3Forms accepts FormData
      });
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-8 text-center text-sm text-slate-500">
            ...
            <div className="mt-2 flex flex-wrap justify-center gap-4">
              <a
                href="mailto:webdeveloperafzaal@gmail.com"
                className="text-blue-600 hover:text-blue-800"
              >
                webdeveloperafzaal@gmail.com
              </a>
              <a
                href="https://wa.me/923103104364"
                target="_blank"
                rel="noopener"
                className="text-blue-600 hover:text-blue-800"
              >

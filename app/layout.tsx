...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Afzaal Chandio', url: 'https://github.com/afzalafzaal029-web' }],
  ...
  verification: {
    google: 'your-google-verification-code', // ← isko apni actual google verification se replace karein
  },
  category: 'technology',
}

...
// ============================================================
// BRAND-ACCURATE SOCIAL ICONS (Square, Colored, Real Logos)
// ============================================================

// Instagram — Gradient background with white camera icon
const InstagramIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="20" height="20">
    ...
    <path fill="url(#instaGrad)" d="M34.017,41.99l-20,0.019c-4.4,0.004-8.003-3.592-8.008-7.992l-0.019-20	c-0.004-4.4,3.592-8.003,7.992-8.008l20-0.019c4.4-0.004,8.003,3.592,8.008,7.992l0.019,20	C42.014,38.383,38.417,41.986,34.017,41.99z"/>
    <radialGradient id="instaGrad2" cx="11.786" cy="5.54" r="29.813" gradientTransform="matrix(1 0 0 .6663 0 1.849)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stopColor="#4168c9"/>
      <stop offset=".999" stopColor="#4168c9" stopOpacity="0"/>
    </radialGradient>
    <path fill="url(#instaGrad2)" d="M34.017,41.99l-20,0.019c-4.4,0.004-8.003-3.592-8.008-7.992l-0.019-20	c-0.004-4.4,3.592-8.003,7.992-8.008l20-0.019c4.4-0.004,8.003,3.592,8.008,7.992l0.019,20	C42.014,38.383,38.417,41.986,34.017,41.99z"/>
    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur-md">
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 md:px-10">
        ...
        <Link href="/" className="text-xl font-bold text-slate-900 shrink-0">
          AFZAAL<span className="text-blue-600">.</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-6 absolute left-1/2 -translate-x-1/2">
          ...
          <Link href="/#work" className="text-sm text-slate-600 hover:text-blue-600 transition">
            Work
          </Link>
          <Link href="/faqs" className="text-sm text-slate-600 hover:text-blue-600 transition">
            FAQs
          </Link>
        </div>
